...
test('verificar-titulo-guru99-bank-home-page', async ({ page }) => {
  await test.step("Then: la página debe mostrar el título correcto", async () => {
    await page.goto('https://demo.guru99.com/V4/');
    const titulo = await page.title();
    expect(titulo).toBe('Guru99 Bank Home Page');
    console.log('Título de la página verificado:', titulo);
  });
});
...
📅 Generación: 24/01/2026, 23:19:54
⏱️  Tiempo: 21051ms (21.1s)
